//
//  EditRejectedValueTalkView.swift
//  SignUp
//
...
struct EditRejectedValueTalkView: View {
  @Bindable var viewModel: EditRejectedValueTalkViewModel
  @FocusState private var focusField: ValueTalkView.Field?
  var didTapBottomButton: () -> Void

  init(
    viewModel: EditRejectedValueTalkViewModel,
