//
//  EditRejectedBasicInfoView.swift
//  SignUp
//
...
struct EditRejectedBasicInfoView: View {
  @State var viewModel: EditRejectedBasicInfoViewModel
...
fileprivate struct CreateContactContainer: View {
  @Bindable var viewModel: EditRejectedBasicInfoViewModel
  private var focusField: FocusState<String?>.Binding
  
  fileprivate init(
    viewModel: EditRejectedBasicInfoViewModel,
